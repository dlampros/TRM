...
public class GUI extends javax.swing.JFrame {
    ...
    private List<String> selectedTaxps;
    private List<String> selectedReceipts;
    private Object selectedTaxp;
    private String category = "1", amountCategory = "1";
    private boolean reqReceipts =false, taxReduction = false, recGathered = false, taxPenalty = false;
    private boolean amPerCategory = false, amForCategory = false;
    ...
    private void initComponents() {
        ...
        pathChooser.setCurrentDirectory(new java.io.File("C:\\Users\\kliker\\Desktop"));
    ...
    private void submitList3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitList3ActionPerformed
        ...
        for(int j=0; j<selectedTaxps.size(); j++) {
            String taxp = selectedTaxps.get(j);
